...
sets = {};
sets{1} = [contrastLUTP' brightnessLUTN' shadowsLUTP' highlightsLUTN' fillLight'];
sets{2} = [contrastLUTN' brightnessLUTP' shadowsLUTP' highlightsLUTN' fillLight'];
% sets{3} = [contrastLUTP' shadowsLUTP'];
sets{3} = [contrastLUTP' shadowsLUTN' highlightsLUTP'];
